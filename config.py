...
parser.add_argument('--seed', default=40, type=int, help="Random seeds for task sampling.")
parser.add_argument('--test_size', default=600, type=int, help="Number of test tasks for evaluation.")
parser.add_argument('--kernel.type', default='rbf', type=str, help="Kernel for HSIC calculation, 'gaussian' or 'linear'.")
parser.add_argument('--epsilon', default=1e-4, type=float, help="Epsilon for variance estimation.")
parser.add_argument('--stat.type', default='median', type=str, help="Statistic for HSIC bandwidth calculation, 'median' or 'quantile'.")
parser.add_argument('--gamma', default=1.0, type=float, help="Gamma for HSIC(Z, Z).")
...
# gamma settings for vary-way vary-shot task
GAMMA_VARY = {
                    "ilsvrc_2012": 3.0,
                    "omniglot": 1.0,
                    "aircraft": 1.0,
...
# gamma settings for 5-shot and 1-shot task
GAMMA_5SHOT = {
                    "ilsvrc_2012": 1.0,
                    "omniglot": 1.0,
                    "aircraft": 1.0,
